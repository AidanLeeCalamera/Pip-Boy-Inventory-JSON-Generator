...
4. Now, come back to this repo, click pull requests, and new pull request. Then, select your fork under head repository, and open the pull request (adding some comments about what you added will help me move through PRs faster, especially it you added a lot).
